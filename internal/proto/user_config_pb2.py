...
_USERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='service_account_json_private_key_path', full_name='acloud.internal.proto.UserConfig.service_account_json_private_key_path', index=19,
